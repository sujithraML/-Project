...
public class SelectPackagesByType extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		tourPackage.setPackage_type(request.getParameter("package_type"));
		tourPackages=tourPackageManager.selectPackagesByPackageType(tourPackage);
		...
		if(tourPackages.isEmpty()) {
			...
			request.setAttribute("filteredByType", tourPackages);
			RequestDispatcher requestDispatcher=request.getRequestDispatcher("tourpackages.jsp");
			requestDispatcher.include(request, response);
		}
	}
