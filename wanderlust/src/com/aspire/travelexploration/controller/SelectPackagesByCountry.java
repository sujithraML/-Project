...
public class SelectPackagesByCountry extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		tourPackage.setCountry(request.getParameter("country"));
		tourPackages=tourPackageManager.selectPackagesByCountry(tourPackage);
		...
		if(tourPackages.isEmpty()) {
			...
			request.setAttribute("filteredByCountry", tourPackages);
			RequestDispatcher requestDispatcher=request.getRequestDispatcher("tourpackages.jsp");
			requestDispatcher.include(request, response);
		}
	}
